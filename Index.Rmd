...
Model1Table <- xtable(LinModel1, label = "html", caption = "First Model Estimation", digits=2)
...
Model2Table <- xtable(LinModel2, label = "html", caption = "Second Model Estimation", digits=2)
