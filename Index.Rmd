...
<<<<<<< Updated upstream
In conclusion, climate factors do not have such a great impact on standardized suicide rates in Italian provinces in year 2009. Among the variables choosen to estimate the model, only annual average precipitation seems to influence suicide rate. The reason for this is that most of suicides take place in Spring and Summer, when heat and humidity affect body cooling, thus causing psychological and behavioural change, which may predispose a person to parasuicidal behaviour [@OECD]. Rain might therefore play a "cooling" effect, preventing this from happening. 
=======
In conclusion, climate factors do not have such a great impact on standardized suicide rates in Italian provinces in year 2009. Among the variables choosen to estimate the model, only annual average precipitation seems to influence suicide rate. The reason for this is that most of suicides take place in Spring and Summer, when heat and humidity affect body cooling, thus causing psychological and behavioural change, which may predispose a person to parasuicidal behaviour [@AGlance2013]. Rain might therefore play a "cooling" effect, preventing this from happening.
>>>>>>> Stashed changes
