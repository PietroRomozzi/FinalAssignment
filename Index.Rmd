...
stargazer(Dataset[,] , summary = T, title = "Data Description", digits = 2, type = "latex", header = F)
...
LinModel1 <- lm(st_suicide_rate ~ gdp_per_capita + unemployment_rate + population + gini_index + avg_temperature + avg_temp_range + avg_precipitations, data = Dataset)

# Summary Table of the Model

library(xtable)

Model1Table <- xtable(LinModel1, caption = "First Model Estimation", digits=2)
...
LinModel2 <- lm(st_suicide_rate ~ gdp_per_capita + unemployment_rate + population + avg_temperature + avg_precipitations, data = Dataset)

Model2Table <- xtable(LinModel2, caption = "Second Model Estimation", digits=2)

print.xtable(Model2Table, comment = F)
```
...
knitr :: kable(CoefTab, digits = 3, caption = "Table of Coefficients")

Confint <- confint(LinModel2)

knitr :: kable(Confint, digits = 3, caption = "Table of Coefficients")
